...
class Aria01 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    Container(
      ...
      child: SizedBox(
        width: 1600,
        child: Container(
          padding: EdgeInsets.fromLTRB(44, 0, 0, 68),
          child: Stack(
            ...
            children: [
              Row(
                ...
                children: [
                  Container(
                    margin: EdgeInsets.fromLTRB(0, 18.5, 53.1, 58.5),
                    child: Stack(
                      children: [
                        Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          ...
                          children: [
                            Container(
                              margin: EdgeInsets.fromLTRB(0, 0, 4.1, 311),
                              child: Text(
                                'Aashifa Sheikh',
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: SizedBox(
                    ...
                    height: 90.9,
                    child: Container(
                      padding: EdgeInsets.fromLTRB(16, 13.5, 0, 13.5),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
